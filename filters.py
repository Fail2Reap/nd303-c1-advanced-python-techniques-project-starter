...
class DateFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :return: A datetime.datetime object representing the
        CloseApproach.time property.
        """
...
class DistanceFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A CloseApproach object.
        :return: A float object representing the
        CloseApproach.distance property.
        """
...
class VelocityFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A CloseApproach object.
        :return: A float object representing the
        CloseApproach.velocity property.
        """
...
class DiameterFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A CloseApproach object.
        :return: A float object representing the NearEarthObject.diameter
        property.
        """
...
class HazardousFilter(AttributeFilter):
    ...
    def get(cls, approach):
        ...
        :param approach: A CloseApproach object.
        :return: A boolean object representing the NearEarthObject.hazardous
        property.
        """
...
def limit(iterator, n=None):
    ...
    """
    return (list(iterator) if n is None or n == 0
            else list(itertools.islice(iterator, 0, n)))
